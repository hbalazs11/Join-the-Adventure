...
public class LabelNames {
    ...
    public static readonly string INVENTORY = "jtaLabelInventory";
    public static readonly string GONEXTROOM = "jtaLabelGoNextRoom";
    public static readonly string MENU = "jtaLabelMenu";
    public static readonly string PICKUP = "jtaLabelPickUp";
